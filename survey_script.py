...
/***************************************************************************
 Survey Script
                                 A QGIS Script
 This script allows you to take a raw CSV from a GPS unit and process the 
 data for insertion into the Ark Spatial Plugin
 
                              -------------------
        begin                : 2021-10-26
        git sha              : $Format:%H$
        copyright            : (C) 2021 by SP Wareing
...
# excess code below if trying to run outside qgis
'''
